...
# Constants
goback="Back"
config="$HOME/.config/wofi/scripts/config"
style="$HOME/.config/wofi/scripts/bluetooth/style.css"
...
wofi_command="wofi -d -i --hide-scroll -W 300 --conf="$config" --style="$style""
